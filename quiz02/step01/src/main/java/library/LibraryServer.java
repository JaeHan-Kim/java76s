...
import library.context.AnnotationApplicationContext;
import library.servlet.Servlet;
...
public class LibraryServer {
  ...
  public LibraryServer() throws Exception {
    context = new AnnotationApplicationContext("library");
    InputStream configInputStream = Resources.getResourceAsStream
        ("library/dao/mybatis-config.xml");
