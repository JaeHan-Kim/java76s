...
public class BoardDao {
  ...
  public BoardDao() {}
  public List<Board> selectList(int pageNo, int pageSize, String keyword, String align) {
    ...
    try {
      ...
      return sqlSession.selectList("java76.pms.dao.BoardDao.selectList", paramMap);
    }  finally {
