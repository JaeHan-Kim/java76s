 ...
 * - 직접 사용되지 않고 ㅅ서브 클래스에 공통 변수 및 공통 메서드를 상속해 주는 용도의
 *   클래스인 경우 이 문법을 사용한다.   
 */
package step07.ex13;
...
public class Test {
  public static void main(String[] args) {
    ...
    // 문제는 코드를 해석하기가 어렵다. <--- 상수 이용
    // s.grade = 1;  // 고졸(1), 2년학사(2), 3년학사(3), 4년학사(4), 석사(4), 박사(5)
    s.grade = Student.MASTER; //위의 코드처럼 숫자를 넣는 것보다 이해하기 쉽다.
    ...
    // => Generalization에서 만든 수퍼 클래스는 보통 직접 사용할 일이 없기 때문에,
    //    추상 클래스로 만든다.
