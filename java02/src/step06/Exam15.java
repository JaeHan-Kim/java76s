...
public class Exam15 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Date today = new Date();  // 현재 날짜 및  시간을 저장한 인스턴스를 생성
    ...
    java.sql.Date date = java.sql.Date.valueOf("2015-08-28");
    ...
    // => 다른 개발자에게 상수 변수임을 인지시키기 위해 보통 대문자르 사용한다.
    final int YEAR = 1;
    final int MONTH = 2;
