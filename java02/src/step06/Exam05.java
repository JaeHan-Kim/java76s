...
public class Exam05 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(sb1);  // sb1이 가리키는 인스턴ㅅ의 값이 변경되었다.
    System.out.println(sb2);  // replace()의 리턴값은 기존 객체 주소이다.
    ...
    // 결과는 false
    // 이유? StingBuffer에 있는 equals()메서드는 그냥 주소가 같은지 비교한다.
    // String은 내용이 같은지 비교하지만 StringBuffer는 그냥 ==와 같다.
    if (x.equals(y))
      System.out.println("x == y");
    
    // SrtringBuffer에서에서 내용을 비교하려면? String 객체를 꺼내서 비교하라!
