...
public class Exam06 /* extends Object*/{
  ...
  public static void main(String[] args) {
    ...
    if (s1 instanceof Student)
      System.out.println("s1 instanceof Subject");
    ...
    System.out.println("-----------------------");
    if (s1 instanceof Student)
      System.out.println("str instanceof Subject");
