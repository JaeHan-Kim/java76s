...
public class Test01_out {
  public static void main(String[] args) throws Exception {
    ...
    // write(int) 
    // => 마지막 2바이트를  읽어서 JVM 기본 문자집합으로 인코딩한다.
    // => FileWriter는 2바이트 단위로 데이터out.write(0xaabbcc);를 다룬다.
    //    이유? 문자 단위가 2바이트이기 때문이다.
    // => FileWriter는 문자 단위로 데이터를 달ㄴ다,
