...
public class Exam07 {
  public static void main(String[] args) {
    ...
    //  => 이렇게 안전하게 저장할 수 있는 정수의 범위를 "유효저랏수"라 부른다.
    ...
    // 부동소수점에는 다만 끝의 값이 짤릴 뿐이다.
    // 그래서 더더욱 주의해서 사용해야 한다.
    f = 989.89898f; // 유효자리수 7자리를 넘어가도 오류 발생하지 않는다. 다만 짤린다.
    System.out.println(f);
    
    f = 989.89898123123123f;  // 다만 짤린다.
    System.out.println(f);
    System.out.println();
