...
public class Exam09 {
  public static void main(String[] args) {
    // 계산1: 2 + 5 * 3 - 1
    // 계산2: 5 + 3 / 2 * 7
    // 조건 연산자 우선 순위 적용하지 않음. 순서대로 처리할 것.
    // 문제점: 두 계산을 다음과 같이 동시에 수행할 수 없다.
    //        => result 변수를 공유하기 때문이다.
    // 해결책: result 변수를 계산1과 계산2에 대해 result 변수를 개별적으로 관리해야 한다.
    //        => Calculator2 클래스를 보라!
    ...
    System.out.println();
    System.out.println(calc3.res1);
    System.out.println(calc4.res1);
  }
}
