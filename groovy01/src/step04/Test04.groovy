...
plus = {
  ...
  // 오직 한 개의 값만 받을 수 있다. 두 개 이상의 값이 들어오면 it를 사용할 수없다.
  println it.getClass().getName();
  //it[0] + it[1]
}

println plus(10)// 값을 한 개를 넘기면 it 변수에는 10이라는 값이 들어간다.
...
// it 변수에는 오직 한 개의 값만 전달할 수 있기 떄문에,
// 여러 개의 값을 전다랗고 싶다면 List로 전달하라!
