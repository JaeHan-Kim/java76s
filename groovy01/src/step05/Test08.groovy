...
// 큰 따옴표를 사용하든 작은 따옴표를 사용하든 상관없이 편하게 문자열을 작성하는 방법
println (/오호라.. "큰 따옴표" 하핳 '작은 따옴표' ^^ /)

// 2) 여려 줄에 걸쳐있는 문자열을 작성하는 방법
println """하하하하
다음 줄에 작성할 수 있을까?
아마 안될텐데..."""
...
// 맨 마지막 문자의 값이 리턴된다.
println "오늘 날짜(파라미터 없는 클로저1): $now 입니다."  // 리턴 값: 오늘 날짜
...
// 파라미터에 값을 넣은 후 다른 문자를 실행할 때
println "오늘 날짜(파라미터 클로저): ${ok -> ok <<'넣었다'; println 'haha'; 'okok'} 입니다."