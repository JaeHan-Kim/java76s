...
public class ProjectUpdateServlet extends HttpServlet{
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println("</tr>");
    out.println("<tr>");
    out.println("<th>시작날짜</th>");
    out.printf("<td><input type='text' value='%s' name='startDate'></td> \n",
        project.getStartDate());
    out.println("</tr>");
    out.println("<tr>");
    out.println("<th>끝날짜</th>");
    out.printf("<td><input type='text' value='%s' name='endDate'></td> \n",
        project.getEndDate());
    out.println("</tr>");
    out.println("<tr>");
    ...
    out.printf("<td><input type='text' value='%s' name='member'></td> \n",
        project.getMember());
    out.println("</tr>");
    out.println("</table>");
    ...
    out.println("<button name='delete' type ='submit' onclick='deleteProject()'>"
        + "삭제</button>");
    out.println("</p>");
